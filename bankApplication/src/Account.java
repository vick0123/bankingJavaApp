...
public class Account {
	...
	void calculateInterest(int years) {
		...
		double newBalance = (balance * interestRate * (years+1))+balance;
		System.out.println();
		System.out.println("The current interest rate is " + df.format(100 * interestRate) + "%");
		System.out.println("After " + years + " years, you balance will be: " + df.format(newBalance));
	}
	...
	void showMenu() {
		...
		do {
			...
			default:
				System.out.println("Error: invalid option. Please enter A, B, C, D, or E or contact HelpDesk Support.");
				break;
			}
		} while(option != 'F');
		scanner.close();
